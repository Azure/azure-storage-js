import {
    deserializationPolicy as NewDeserializationPolicy, HttpClient as IHttpClient,
    HttpPipelineLogger as IHttpPipelineLogger, RequestPolicyFactory
} from "ms-rest-js";
...
export abstract class StorageURL {
  ...
  public static newPipeline(
    ...
    factories.push(NewDeserializationPolicy());
